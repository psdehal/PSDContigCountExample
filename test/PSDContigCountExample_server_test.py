...
from PSDContigCountExample.PSDContigCountExampleImpl import PSDContigCountExample


class PSDContigCountExampleTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('PSDContigCountExample'):
            cls.cfg[nameval[0]] = nameval[1]
        cls.wsURL = cls.cfg['workspace-url']
        cls.wsClient = workspaceService(cls.wsURL, token=token)
        cls.serviceImpl = PSDContigCountExample(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_PSDContigCountExample_" + str(suffix)
